...
import com.anthrobyte.camunda.aiagent.config.OrganizationAuthAutoConfiguration;
    ...
    return new ApplicationContextRunner()
        .withConfiguration(
            AutoConfigurations.of(
                OrganizationAuthAutoConfiguration.class, AgenticAiConnectorsAutoConfiguration.class))
